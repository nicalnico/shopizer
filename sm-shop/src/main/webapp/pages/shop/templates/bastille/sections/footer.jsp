				...
				<div class="row">
					<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 mar_b-30">
						<div class="copyright text-left">
							<p><sm:storeCopy/>&nbsp;-&nbsp;<s:message code="label.generic.providedby" /> <a href="" class="footer-href" target="_blank">Nical Corp</a></p>
						</div>
					</div>
...
<!-- 						<img src="/resources/img/payment/icons/PayPal.png" width="50" alt="" /> -->
						</div>
						</c:if>
					</div>
				</div>
		...
		s1.async=true;
		s1.src='https://embed.tawk.to/5b10d00510b99c7b36d485f3/default';
		s1.charset='UTF-8';
