...
<script>
  gtag('event', 'conversion', {
      ...
      'value': '<c:out value="${order.total.value}"/>',
      'currency': 'AUD',
			...
			<div class="row text-center" style="margin-top: 5px;">
				<div class="signup">
					<form action="https://labastille.us18.list-manage.com/subscribe/post?u=0c2a7258b68e61aa3c539ff35&amp;id=70c2c820ab" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
					    <div>
							<p>Would you like to get the latest news, exciting offers and discounts to your inbox</p>
							<div class="">			
								<label for="mce-EMAIL"><i class="fa fa-envelope-o"></i></label>
								<input type="email" name="EMAIL" class="required email" id="mce-EMAIL" title="Email Address" class="input-text required-entry validate-email" value="<c:out value="${order.customer.emailAddress}" />" />				
